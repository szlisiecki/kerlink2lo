...
import org.springframework.web.client.RestTemplate;
    ...
    public class LoDeviceProviderTest3 {
        ...
        public void shouldReturn5devices() {
            ...
            when(loProperties.getDevicesUrl()).thenReturn("localhost");
            ...
            LoDeviceProvider loDeviceProvider = new LoDeviceProvider(loProperties, httpHeaders);
